...
<div id="carousel-example-generic"
	...
	<div class="carousel-inner edufair-inner single-inner" role="listbox">
		<div class="edufair-overlay">
			<img src="images/university/page-bg3.jpg" alt="slide 1"
	...
	<div class="container">
		...
		<div class="edufair-subscription-form-1x">
			<form action="/member/register" method="POST">
				<div class="col-md-12">
					<div class="form-group">
						<label for="userId">아이디</label> <input type="text" id="userId"
							class="form-control" name="userId" placeholder="아이디를 입력해주세요."
							required>
				...
				<div class="col-md-12">
					<div class="form-group">
						<label for="userPw">비밀번호</label> <input type="password"
							class="form-control" name="userPw" placeholder="비밀번호를 입력해주세요."
							required>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group">
						<label for="userName">닉네임</label> <input type="text"
							class="form-control" name="userName" placeholder="닉네임을 입력해주세요."
							required>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group">
						<label for="phone">휴대전화</label> <input type="tel"
				...
				<div class="col-md-12">
					<div class="form-group">
						<label for="address">주소</label> <input type="text"
							class="form-control" name="address" placeholder="주소를 입력해주세요."
							required>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<label for="gender">성별 &nbsp </label> <label class="radio-inline">
							<input type="radio" name="gender" value="남" checked>남성
						</label> <label class="radio-inline"> <input type="radio"
							name="gender" value="여">여성
						</label>
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="form-group">
						<label for="sms">SMS 수신 &nbsp </label> <label class="radio-inline">
			...
			<div class="col-md-12 terms-condition">
				<p>
					이미 회원이신가요? <a href="/member/login" class=""> 로그인 </a>
				</p>
			</div>
		</div>
	</div>
