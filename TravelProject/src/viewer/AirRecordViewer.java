...
public class AirRecordViewer {
    ...
    private void showAdminMenu() {
        ...
        String message = "1. 전체 항공 예약 정보 보기 2. 뒤로 가기";
        while (true) {
    ...
    // 유저의 본인이 예약한 목록 볼 수 있게.. 어떻게 함? ㅜ ㅜ 아이디 연동 시키기 어렵넹..
    private void showGeneralMenu() {
        String message = "1. 나의 예매 내역 보기 2. 예매하기 3.뒤로 가기";
        while (true) {
            int userChoice = ScannerUtil.nextInt(scanner, message);
    ...
    private void printOne(int id) {
        ...
        System.out.printf("예매일: %s", sdf.format(a.getReservationDate()));
    ...
    public int selectAirRecordById(int id) {
        return airRecordController.selectOne(id).getId();
    }
